...
*/
//document.domain = 'ilab.joins.com';
...
(function (window, document, $) {
    ...
    window.ARTICLE_TYPE = { general: 'General', cover: 'Cover', live: 'Live', piki: 'Piki' };

    window.APPLICATION_TYPE = { pc: 'pc', mobile: 'mobile' };
    window.DEVICE_TYPE = { pc: 'pc', mobile: 'mobile' };

    window.PAGE_TYPE = { index: 'Home', section: 'Section', list: 'List', article: 'Article', search: 'Search', unique: 'Unique', reporter: 'Reporter', issue: 'Issue' };
    ...
    */
    var
        defaults = {
            ...
            'cmsHost': { 'editable': false, 'value': 'https://jcms.joins.com' },
	    ...
	    */
        ...
        this.setStartPage = function () {
            ...
            if (document.all) {
                ...
                document.body.setHomePage('https://joongang.joins.com');
        ...
        this.getUrlFormat = function (key, value) {
            ...
            var applicationType = utils.config('applicationType'),
                ...
                URL_FORMAT = {
                    ...
                    people: 'https://people.joins.com/Search/?pgi=1&ps=&q={VALUE}',
                    jtbc: '/jtbc'
                };
        ...
        this.getIrPath = function (url, w, h, addStr) {
        ...
        this.getBlurImage = function (imageUrl) {
            //https://dev.ir.joins.com/?u=https://dev.pds.joins.com/news/component/article_template/html_content/201508/maxresdefault.jpg&w=100&h=200&t=c&b=
            if (imageUrl) {
        ...
        this.serverDate = new function () {
            var _serverDate = this,
                ...
                dateFile = 'https://static.joins.com/common/data/nowdaytime/daytimer.js';
        ...
        this.newsRoom = new function () {
            ...
            return {
                ...
                init: function () {
                    ...
                    var jtbcScheduleFile = 'https://fs.jtbc.joins.com/common/data/schedule/schedule_day3.js';
        ...
        this.opinionCast = new function () {
            ...
            return {
                ...
                init: function () {
                    ...
                    var opinionCastSchedule = 'https://static.joins.com/joongang_15re/scripts/data/opinioncast/js/index_onair_schedule.js',
                        opinionCastScheduleTemp = 'https://local.static.joins.com/scripts/data/opinioncast/js/index_onair_schedule.js';

                    //opinionCastSchedule = opinionCastScheduleTemp;
        ...
        this.setTrackingLog = function (options) {
            ...
            var logMaps = {
                'photo': { url: 'https://log.news.joins.com/PhotoGalleryLogCollector.html?div=' },
                'image': { url: 'https://log.news.joins.com/BundlePhotoLogCollector.html?div=' },
                'article': { url: 'https://log.news.joins.com/NewsArticleLogCollector.html?div=' }
            };
        ...
        this.shareHandler = new function () {
                ...
                services = {
                    facebook: function facebook(url) {
                        ...
                        var params = { u: setDomain(url) },
                            path = 'https://facebook.com/sharer.php',
                    ...
                    kakaostory: function kakaostory(url, title) {
                        ...
                        Kakao.Story.share({
                            url: setDomain(url),
                            //url: 'https://news.joins.com/article/554/18532554.html?ctg=1000&cloc=joongang|home|top', //test
                            text: title
                        });
                    },
            ...
            function setDomain(path) {
                var domainPath = utils.isMobile() ? utils.config('webMobilePath') : utils.config('webPcPath'); // 'https://' + location.host;
            ...
            function snsCounting(target, service, id) {
                ...
                //https://local.apis.joins.com/news/17336581/share (DeviceType=Mobile, SharedType={Facebook,Twitter,Instagram,GooglePlus,KakaoTalk,KakaoStory,Pinterest,Email)
                //https://local.apis.joins.com/issue/123423/share (DeviceType=Mobile)
        ...
        this.favoriteMenus = new function () {
            ...
            defaultMenuCode = 'A2,A1,D1,C7,B9,C1';
        ...
        this.redirectUrl = function () {
            ...
            function getSearchRedirectObject() {
                var mapper = {
                    ...
                    pc: 'https://search.joins.com' + search
                }
            ...
            function getExternalRedirectObject(type) {
                var mapper = {
                    ...
                    'jplus': {
                        mobile: 'https://m.jplus.joins.com' + path + search,
                        pc: 'https://jplus.joins.com' + path + search
                    },
                    'gangnam': {
                        mobile: 'https://m.gangnam.joins.com',
                        pc: 'https://gangnam.joins.com'
                    }
                };
    ...
    window.userInfo = new function UserInfo() {
        ...
        var USER_TYPE = { joins: 'joins', twitter: 'twitter', facebook: 'facebook' },
            COOKIE_NAMES = { id: 'Joins_MemID', name: 'Joins_MemName', status: 'Joins_LoginStatus', valid: 'Joins_ValidLogin', memArray: 'MemArray', ssoInfo: 'SSOInfo' },
        ...
        this.isLogin = function () {
            return utils.getCookie(COOKIE_NAMES.memArray) && utils.getCookie(COOKIE_NAMES.ssoInfo) ? true : false;
        };
    ...
    window.commentUserInfo = new function CommentUserInfo() {
        var _commentUserInfo = this,
            SERVICE_TYPE = { joins: 'joins', twitter: 'twitter', facebook: 'facebook' },
    ...
    utils.getTargetFilter = function (_url) {
        var blankFilter = ['nk.joins.com', 'tong.joins.com', 'paper.joins.com', 'jmembership.joins.com', 'subscribe.joins.com', 'people.joins.com', 'weather.joins.com', 'mediaspider.joins.com', 'gangnam.joins.com'],
            target = '',
            url = _url;
